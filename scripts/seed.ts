...
async function main() {
    ...
    if (!existingAdmin && adminBootstrapPassword) {
        const hashedPassword = await bcrypt.hash(adminBootstrapPassword, 12);
        ...
        console.log('This bootstrap admin must rotate its password and enable 2FA after the first sign-in.');
    } else if (!existingAdmin) {
        console.log('Skipping admin bootstrap. Set ADMIN_BOOTSTRAP_PASSWORD to seed an admin securely.');
    } else {
    ...
    // 2. Create Categories
    const categories = [
        { name: 'AI Video Tools', slug: 'ai-video-tools', icon: 'video' },
        { name: 'AI Image Tools', slug: 'ai-image-tools', icon: 'image' },
        { name: 'AI Writing Tools', slug: 'ai-writing-tools', icon: 'writing' },
        { name: 'AI Coding Tools', slug: 'ai-coding-tools', icon: 'coding' },
        { name: 'AI Automation Tools', slug: 'ai-automation-tools', icon: 'automation' },
        { name: 'AI Marketing Tools', slug: 'ai-marketing-tools', icon: 'marketing' },
        { name: 'Agentic AI Tools', slug: 'ai-agentic-tools', icon: 'agentic' },
        { name: 'SEO Tools', slug: 'seo-tools', icon: 'seo' },
    ];
