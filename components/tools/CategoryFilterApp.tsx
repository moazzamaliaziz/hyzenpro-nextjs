        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:hidden flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <label htmlFor={mobileSortId} className="sr-only">
                        Sort tools
                    </label>
                    <select
                        id={mobileSortId}
                        ...
                        className="text-sm bg-transparent border-none focus:ring-0 cursor-pointer text-black"
                    >
            ...
            <div className="flex-1">
                ...
                <div className="hidden lg:flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        <label htmlFor={desktopSortId} className="text-sm text-gray-500">Sort by:</label>
                        <div className="relative">
                            <select
                                id={desktopSortId}
                                value={sortBy}
                                onChange={(e) => setSortBy(e.target.value as SortOption)}
                                className="appearance-none bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg py-2 pl-4 pr-10 text-sm font-medium text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white cursor-pointer"
                            >
                                <option value="popular">Most Popular</option>
                                <option value="alphabetical">Alphabetical</option>
                            </select>
