...
interface CompareContextType {
    ...
    setTools: (tools: CompareTool[]) => void;
...
export function CompareProvider({ children }: { children: React.ReactNode }) {
    ...
    const setTools = (tools: CompareTool[]) => {
    ...
    return (
        <CompareContext.Provider value={{ selectedTools, addTool, setTools, removeTool, clearTools, isToolSelected }}>
            {children}
