...
export default function RichTextEditor({ value, onChange, placeholder }: RichTextEditorProps) {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'min-h-[400px] p-6 text-white/90 prose prose-invert max-w-none outline-none prose-headings:font-bold prose-h1:text-3xl prose-h2:text-2xl prose-h3:text-xl prose-h4:text-lg prose-a:text-accent prose-blockquote:border-l-4 prose-blockquote:border-accent/50 prose-blockquote:pl-4 prose-blockquote:italic prose-pre:bg-white/5 prose-pre:p-4 prose-pre:rounded-lg prose-pre:font-mono prose-pre:text-sm prose-table:border-collapse prose-td:border prose-td:border-white/10 prose-td:p-2 prose-th:border prose-th:border-white/10 prose-th:p-2 prose-th:bg-white/5 prose-img:rounded-lg prose-img:max-w-full',
            },
        },
    });
        ...
        <div className="border border-white/10 rounded-xl overflow-hidden bg-white/[0.02]">
            ...
            {showSource ? (
                <textarea
                    ...
                    className="w-full min-h-[400px] p-6 bg-transparent text-white/90 text-sm font-mono resize-y outline-none"
