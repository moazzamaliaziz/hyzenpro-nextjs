...
import { buildToolCanonicalPath } from '@/lib/tool-publish';
                                    ...
                                    <tr key={tool.id} className="hover:bg-white/[0.02] transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-end gap-3">
                                                <Link href={buildToolCanonicalPath(tool.primaryCategory, tool.slug)} target="_blank" className="p-2 text-white/30 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
