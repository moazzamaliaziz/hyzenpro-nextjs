...
export default function SecuritySettingsClient({ isTwoFactorEnabled }: Props) {
        ...
        <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 max-w-2xl">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        {enabled ? '2FA is currently enabled on your account.' : 'Add an extra layer of security to your account.'}
                    </p>
                </div>
            </div>
            ...
            {enabled && (
                <div className="border-t border-gray-200 dark:border-gray-800 pt-6 mt-6">
                    <p className="text-sm text-gray-500 mb-4">To disable 2FA, please enter a valid verification code from your authenticator app.</p>
                    <div className="flex gap-4 max-w-xs">
                        <input
                            type="text"
                            maxLength={6}
                        ...
                        <button
                            ...
                            disabled={loading || token.length !== 6}
                            className="px-6 py-3 bg-red-600 text-white font-bold uppercase text-sm hover:bg-red-700 disabled:opacity-50 transition-all border border-red-700"
                        >
