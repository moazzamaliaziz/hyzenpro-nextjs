                            ...
                            <div>
                                ...
                                <div className="flex gap-4 items-center">
                                    <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center p-2 shrink-0">
                                        ...
                                        <img src={globalSettings.logoUrl || '/images/logo.png'} alt="Logo Preview" className="max-w-full max-h-full object-contain" onError={(e) => (e.currentTarget.src = '/images/logo.png')} />
                                    </div>
                                    <input 
                                        type="text" 
                            ...
                            <div>
                                ...
                                <div className="flex gap-4 items-center">
                                    <div className="w-10 h-10 bg-white/5 border border-white/10 rounded-lg flex items-center justify-center p-2 shrink-0">
                                        {/* eslint-disable-next-line @next/next/no-img-element */}
                                        <img src={globalSettings.faviconUrl || '/favicon.ico'} alt="Favicon Preview" className="max-w-full max-h-full object-contain" onError={(e) => (e.currentTarget.style.display = 'none')} />
                                    </div>
                                    <input 
                                        type="text" 
